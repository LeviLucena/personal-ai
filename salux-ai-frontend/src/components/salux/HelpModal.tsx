...
import { exampleQueries } from "@/lib/salux-workflows";
        ...
        >
          ...
          >
            ...
            <p className="mt-4 text-[11px] text-white/45 leading-relaxed">
              O workflow é detectado automaticamente pelo conteúdo da mensagem. Toque na orb ou no microfone para falar.
            </p>
          </motion.div>
        </motion.div>
      )}
